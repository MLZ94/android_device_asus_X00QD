 ...
 */
 ...
 /* 
 * Lights HAL for Asus X00QD (RG led and LCD BACKLIGHT)
 *    RG led scenarios:
 *       Battery:
 *           -red blink
 *           -red light
...
Light::Light(std::pair<std::ofstream, uint32_t>&& lcd_backlight,
             std::ofstream&& red_blink, std::ofstream&& red_led, 
             std::ofstream&& green_blink, std::ofstream&& green_led)
    ...
    auto buttonsFn(std::bind(&Light::setButtonsBacklight, this, std::placeholders::_1)); //fake button dummy
